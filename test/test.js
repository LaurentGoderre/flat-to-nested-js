...
describe('flatToNested', function () {
  ...
  describe('using function to get id', function () {
    ...
    it('should convert using the correct id', function () {
      ...
      flat = [{config:{id: 1}}, {config: {id: 11}, parent: 1}, {config:{id: 12}, parent: 1}, {config:{id: 111}, parent: 11}];
  ...
  describe('using advanced nested children property', function () {
    var flatToNested;
    ...
    it('should convert using the nested children property', function() {
      var flat, expected, actual;

      flat = [{id: 1}, {id: 2, parent: 1}];

      expected = {id: 1, relationships: {children: [{id: 2}]}};
  ...
  describe('children based hierarchy', function() {
    ...
    describe('using advanced nested children property', function () {
      ...
      it('should convert using the nested children property', function() {
        ...
        flat = [{id: 12, value: 1}, {id: 111, value: 2}, {id: 11, relationships: {children: [111]}}, {id: 1, relationships:{children: [11, 12]}}, ];

        expected = {id: 1, relationships: {children: [
          {id: 11, relationships: {
            children: [
              {id: 111, value: 2}
            ]
